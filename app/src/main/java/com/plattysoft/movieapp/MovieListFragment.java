...
import com.plattysoft.movieapp.api.MoviesApi.MovieListener;
...
public class MovieListFragment extends ListFragment {
	...
	private void loadMovies() {
		// Do an API call and populate the adapter on return        
		MoviesApiFactory.getInstance().getPopularMovies(new MovieListener() {
            @Override
            public void onMoviesReady(List<Movie> result) {
                setListAdapter(new MoviesAdapter(getActivity(), result));
            }
        });
	}
    ...
    public void onListItemClick(ListView listView, View view, int position, long id) {
        ...
        Movie item = (Movie) listView.getAdapter().getItem(position);
